...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mHttps.dishant.ceh \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border https.dishant.ceh
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[4;32m   Instagram: https://www.instagram.com/https.dishant.ceh/profilecard/?igsh=MTBsZTJhcm13bHVtdA=="
    echo " "
